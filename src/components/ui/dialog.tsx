...
>(({ className, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-[10000] w-[calc(100vw-2rem)] max-w-lg",
        "translate-x-[-50%] translate-y-[-50%] rounded-xl border border-white/10",
        "bg-zinc-950/95 p-5 text-white shadow-2xl outline-none",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
